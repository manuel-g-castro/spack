...
class Libgridxc(AutotoolsPackage,MakefilePackage):
    ...
    version("2.0.1", tag="2.0.1", commit="8311c3ec164832f82255d1d487ada8a6909192e7")
    version("2.0.0", tag="2.0.0", commit="77058d35f5f46b137ce068bba7c3ce9132764c8e")
    version("1.1.2", tag="1.1.2", commit="f2110885d0ae508f3aa8547dc7da58ab7a6895c2")
    version("1.1.0", tag="1.1.0", commit="b6633413d09c5286597414dd19349e5bdc15f0a4")
