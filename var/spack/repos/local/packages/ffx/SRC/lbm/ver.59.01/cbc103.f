      SUBROUTINE CBC103(NG,NP,ILEVEL,IPOSI,F,FBC1)
      IMPLICIT NONE
...
C
C     ====FUNCTION====
C     SET B.C. DATA TO F FROM FACE-TYPE B.C. BUFFER WITH B.C. FLAG-TYPE OF 003
