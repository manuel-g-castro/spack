...
C                                                                      C
C======================================================================C
      SUBROUTINE SOLVEF(IDIM,IMASS,AC,CM,IPNP,NPP,MAXP,MAXPP,NP,
...
C
      CHARACTER*72 ERMSG
     & /' *** SUBROUTINE SOLVEF REPORTS A FATAL ERROR OCCURENCE ***' /
      CHARACTER*72 EREXP1
     & /' NO ROOM LEFT IN S(MAXP) FOR CONDUCTING SOLVEF OPERATIONS' /
      CHARACTER*72 EREXP2
     & /' MAXPP IS TOO SMALL TO CONDUCT SOLVEF OPERATIONS' /
C
C
...
C
      ...
      ENDIF
C
C      CLEAR THE ARRAY S(IP) FOR SOLVEF OPERATIONS
C
      DO 100 IP = NP+1 , MAXP
          S(IP) = 0.D0
  100 CONTINUE
