...
C
      ...
      ELSE IF(IMODE.EQ.4) THEN
          WRITE(IUT6,*) 
          WRITE(IUT6,*) '  GFCUBE :: WRITING GF-CUBE FILE  (OPEN) '
          GOTO 2000
      ELSE IF(IMODE.EQ.6) THEN
          WRITE(IUT6,*) 
          WRITE(IUT6,*) '  GFCUBE :: WRITING GF-CUBE FILE  (APPEND) '
          GOTO 2200
      ELSE IF(IMODE.EQ.8) THEN
          WRITE(IUT6,*) 
          WRITE(IUT6,*) '  GFCUBE :: WRITING GF-CUBE FILE  (CLOSE) '
          GOTO 2100
      ELSE
          IERR=1
          RETURN
...
C
 2200 CONTINUE
     ...
     *           '*LBM_CSZ *LBM_BND *LBM_LPQ !',
     *           NAME,NG,
     *           NAME,MPBOUN,N5,NPBOUN,N5,LPBOUN,
     *           NAME,MPBOUN,NPBOUN,QBOUN, 
     *           ICHECK)
C
      RETURN
      END
