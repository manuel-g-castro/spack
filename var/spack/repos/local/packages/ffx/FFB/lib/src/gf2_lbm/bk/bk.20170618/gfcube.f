...
C
     ...
     *               IACT,IWRITE,INAME,IRESV,  
     *               ICAST,IDATA0,IALL,ISKIP,IERR,
     *               '*LBM_CSZ *LBM_LEV *LBM_POS *LBM_OUT *LBM_LCB !',
     *               NAME,NG,
     *               NAME,LLEVEL(IC),
     *               NAME,N03,NDUM,LPOSI(1,IC),
     *               NAME,N26,NDUM,LCOUT(1,IC),
