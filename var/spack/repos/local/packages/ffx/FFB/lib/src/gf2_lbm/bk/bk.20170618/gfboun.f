      SUBROUTINE GFBOUN(IMODE,MC,MPSOLD,MPBOUN,FILEGM,
     *                  NG,NC,NPSOLD,NPBOUN,
     *                  LPSOLD,LPBOUN,QBOUN,
     *                  MCOM,NCOMFL,NCOMST,COMFLE,COMSET,
     *                  IUT6,IUT0,IUTGM,IERR)
      IMPLICIT NONE
      INTEGER*4    IMODE,MC,MPSOLD,MPBOUN,NG,NC
      INTEGER*4    NPSOLD(MC),LPSOLD(MPSOLD,MC),
...
C
     ...
     *               ICHECK)
          ...
          IF(IBUF3.GT.MPBOUN) MPBOUN=IBUF5
  200 CONTINUE
C
