...
void CheckVolKWayPartitionParams(CtrlType *ctrl, GraphType *graph, int nparts)
{
  ...
  tmpdegrees = (VEDegreeType *)GKmalloc(sizeof(VEDegreeType)*(size_t)nparts, "CheckVolKWayPartitionParams: tmpdegrees");
...
void EliminateVolSubDomainEdges(CtrlType *ctrl, GraphType *graph, int nparts, float *tpwgts)
{
  ...
  cand = (KeyValueType *)GKmalloc(sizeof(KeyValueType)*(size_t)nparts, "EliminateSubDomainEdges: cand");
  cand2 = (KeyValueType *)GKmalloc(sizeof(KeyValueType)*(size_t)nparts, "EliminateSubDomainEdges: cand");
