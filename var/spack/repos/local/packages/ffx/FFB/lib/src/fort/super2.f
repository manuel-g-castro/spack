...
C                                                                      C
C======================================================================C
      SUBROUTINE SUPER2(IDIM,R,IENP,JENP,NEP,MAXE,MAXEP,NE,NP,N,
     *                  F,IUT0,IERR)
      IMPLICIT REAL*8(A-H,O-Z)
      DIMENSION R(N,NE),IENP(MAXEP,NP),JENP(MAXEP,NP),NEP(NP),F(NP)
C
      CHARACTER*72 ERMSG
     & /' *** SUBROUTINE SUPER2 REPORTS A FATAL ERROR OCCURENCE ***' /
      CHARACTER*72 EREXP1
     & /' NO ROOM LEFT IN ARRAY R    FOR CONDUCTING SUPER2 OPERATIONS' /
      CHARACTER*72 EREXP2
     & /' MAXEP IS TOO SMALL TO CONDUCT SUPER2 OPERATIONS' /
C
C
