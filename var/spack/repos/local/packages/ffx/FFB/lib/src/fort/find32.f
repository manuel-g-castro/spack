...
C                                                                      C
C======================================================================C
      SUBROUTINE FIND32(ELM,NE,XM,YM,ZM,IEM,NM,NITER,GM,EM,TM,
     *                  JCHECK,DELTA,ERRMAX)
      IMPLICIT REAL*4(A-H,O-Z)
      DIMENSION ELM(24,NE),XM(NM),YM(NM),ZM(NM),IEM(NM),
...
C              CALCULATED ONLY FOR POINTS WITH POSITIVE ELEMENT NUMBER,
C              BY THE NEWTON LAPSON METHODS.
C
