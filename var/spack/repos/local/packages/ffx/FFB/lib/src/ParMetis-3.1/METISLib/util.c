...
int *imalloc(int n, char *msg)
{
  ...
  return (int *)GKmalloc(sizeof(int)*(size_t)n, msg);
}
...
idxtype *idxmalloc(int n, char *msg)
{
  ...
  return (idxtype *)GKmalloc(sizeof(idxtype)*(size_t)n, msg);
}
...
float *fmalloc(int n, char *msg)
{
  ...
  return (float *)GKmalloc(sizeof(float)*(size_t)n, msg);
}
...
int *ismalloc(int n, int ival, char *msg)
{
  ...
  return iset(n, ival, (int *)GKmalloc(sizeof(int)*(size_t)n, msg));
}
...
idxtype *idxsmalloc(int n, idxtype ival, char *msg)
{
  ...
  return idxset(n, ival, (idxtype *)GKmalloc(sizeof(idxtype)*(size_t)n, msg));
}
