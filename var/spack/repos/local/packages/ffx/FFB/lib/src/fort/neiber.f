...
C                                                                      C
C======================================================================C
      SUBROUTINE NEIBER(IMODE,NODE,NE,NP,N,MAXE,MAXP,MAXEP,MAXPP,MAXEE,
     *                  IENP,JENP,NEP,IPNP,NPP,IENE,NEE,LIST,IUT0,IERR)
      DIMENSION NODE(N,NE),IENP(MAXEP,NP),IPNP(MAXPP,NP),IENE(MAXEE,NE),
     1          NEP(NP),NPP(NP),NEE(NE),JENP(MAXEP,NP),LIST(N,N,NE)
C
      CHARACTER*60 ERMSGB
     & / ' ## SUBROUTINE NEIBER: FATAL      ERROR OCCURENCE; RETURNED' /
      CHARACTER*60 EREXP1
