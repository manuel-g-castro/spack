      SUBROUTINE BCGS2X(IMODE,IPART,NMAX,EPS,EPSRE,
     *                  ME,N2,NE,NEX,NP,
     *                  NPP,NCRS,IPCRS,AAAPC,NODE,B,S,NITR,RES,
...
CCC  [LOCAL VARIABLE]    
     ...
     *       EPS0,RESR,RESMIN,ALFA,BETA
      DATA EPS0 / 1.E-30 /
C
      CHARACTER*60 ERMSGC
     & /' ## SUBROUTINE BCGST2X: FATAL     ERROR REPORT   ; RETURNED' /
C
...
C                              12 WORDS BY LIST )
      CALL CALAXC(AAAPC, S, RK, NP, NE, NCRS, IPCRS, NPP,
...
C                               4 WORDS BY 4-WORD STRIDE, AND
C                              12 WORDS BY LIST )
      CALL CALAXC(AAAPC, PK, APK, NP, NE, NCRS, IPCRS, NPP,
     *            N2,ME,IPART,LDOM,NBPDOM,NDOM,IPSLF,IPSND,MBPDOM,
     *            RX,RY,IUT0,IERR,
     *            N2,NEX,NODE, 
     *            MWRK,WRKN,
...
C                               4 WORDS BY 4-WORD STRIDE, AND
C                              12 WORDS BY LIST )
      CALL CALAXC(AAAPC, TK, ATK, NP, NE, NCRS, IPCRS, NPP,
     *            N2,ME,IPART,LDOM,NBPDOM,NDOM,IPSLF,IPSND,MBPDOM,
     *            RX,RY,IUT0,IERR,
     *            N2,NEX,NODE, 
     *            MWRK,WRKN,
