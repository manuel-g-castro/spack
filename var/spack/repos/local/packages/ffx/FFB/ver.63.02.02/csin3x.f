...
C                                                                      C
C======================================================================C
      SUBROUTINE CSIN3X(LOCAL,X,Y,Z,NODE,NE,NP,N2,NEX,NS,NSP,
     *                  LEB,NB,XNB,YNB,ZNB,A)
      IMPLICIT NONE
C
      INTEGER*4 LOCAL,NODE,NE,NP,N2,NS,NSP,LEB,NB,NEX
      REAL*8    X,Y,Z
      REAL*4    XNB,YNB,ZNB,A
      DIMENSION X(NP),Y(NP),Z(NP),NODE(N2,NE),NEX(8),
     1          LEB(2,NB),XNB(NB),YNB(NB),ZNB(NB),A(NB)
C
