...
C                                                                      C
C======================================================================C
      SUBROUTINE SRFEX2(MESURF,MLST,NE,NP,N2,NEX,NS,NSP,N2D,
     *                  LPNT,NPNT,LOCAL,NODE,LMASK,
     *                  LESURF,NESURF,MWRK,IWRK,IUT0,IERR)
C
      IMPLICIT NONE
C
      INTEGER*4 MESURF,MLST,NE,NP,N2,NEX,NS,NSP,N2D,
     *          LPNT,NPNT,LOCAL,NODE,LMASK,
     *          LESURF,NESURF,MWRK,IWRK,IUT0,IERR
C
      DIMENSION LPNT(NPNT),LOCAL(NSP,NS,4),NODE(N2,NE),NEX(8),
     1          LESURF(MLST,MESURF),IWRK(MWRK),LMASK(NE)
C
      CHARACTER*60 ERMSGB
...
C
      INTEGER*4 IPNT,IP,IS,IE,IETYPE,I,II,J,IPF,J1,J2,IS1,IE1,IS2,IE2,
     *          IETYPE1,IETYPE2,LIST1,LIST2,IMATCH,NSURF,NBUF
C
