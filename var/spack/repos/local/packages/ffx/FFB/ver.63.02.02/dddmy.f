...
C
     ...
     *                  LDOM,NBPDOM,NDOM,IPSLF,IPSND,IUT0,IERR)
      IMPLICIT NONE
      INTEGER*4 LPINT1,LPINT2,LPINT3,NPINT,MDOM,MBPDOM,
     *          LDOM,NBPDOM,NDOM,IPSLF,IPSND,IUT0,IERR
      INTEGER*4 IDOM,IPINT,IFNEW,ICHK
...
C
      ...
      IMPLICIT NONE
      INTEGER*4 LPINT1,NPINT,NUMIP,NP,IUT0,IERR
...
C
     ...
     *                  FX,FY,FZ,NP,IUT0,IERR,BUFSND,BUFRCV,MAXBUF)
      IMPLICIT NONE
      INTEGER*4 IPART,IDIM,LDOM,NBPDOM,NDOM,IPSLF,IPSND,MBPDOM,
     *          NP,IUT0,IERR,MAXBUF
      REAL*4    FX,FY,FZ,BUFSND,BUFRCV
      INTEGER*4 IDOM,IP,IPS,IBP,NSTART
...
C
     ...
     *                  NRCV,LRCV,NPTRCV,IERR)
      IMPLICIT NONE
      INTEGER*4 LPSET1,LPSET3,NPSET,MPT,MDOM,IUT0,
     *          NSND,LSND,NPTSND,IPSET,IPSRC,
     *          NRCV,LRCV,NPTRCV,IERR
      INTEGER*4 IDOM,IP,IPS,IBP,NSTART,NDUM,IFNEW,ICHK
...
C
     ...
     *                  IDIM,MPT,IUT0,IERR,BUFSND,BUFRCV,MAXBUF)
      IMPLICIT NONE
      INTEGER*4 NSND,LSND,NPTSND,IPSET,IPSRC,NB,NRCV,LRCV,NPTRCV,NP,
     *          IDIM,MPT,IUT0,IERR,MAXBUF
      REAL*4    VALX,VALY,VALZ,FX,FY,FZ,BUFSND,BUFRCV
