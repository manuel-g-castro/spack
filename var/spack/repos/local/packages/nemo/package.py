...
class Nemo(Package):
    ...
    patch(
        "https://raw.githubusercontent.com/fujitsu/oss-patches-for-a64fx/master/Nemo/fj-v4.2.0.patch",
        sha256="b6f6f3e49275eaf6002f29bbbc801c8e6c8214c5d3d672365ff9a65a7932e8f7",
        when="@4.2.0%fj",
    )
    patch(
        "https://raw.githubusercontent.com/fujitsu/oss-patches-for-a64fx/master/Nemo/fj-v4.2.1.patch",
        sha256="e32f48b6d56deec6da6730e76155bf4c1f375afdff1f5d50ca9171385d60a2bd",
        when="@4.2.1%fj",
    )
