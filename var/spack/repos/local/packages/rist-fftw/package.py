...
class RistFftw(AutotoolsPackage):
    ...
    version('3.3.8', sha256='6113262f6e92c5bd474f2875fa1b01054c4ad5040f6b0da7c03c98821d9ae303', preferred=True)
    ...
    def configure(self, spec, prefix):
        ...
        if spec.target == 'a64fx':
            simd_options.append('--disable-neon')
        else:
        ...
        if spec.target == 'a64fx':
            if spec.version == Version('3.3.9-272-g63d6bd70'):
                simd_options.append('--enable-sve')
                simd_options.append('CFLAGS=-Ofast')
        ...
        if spec.target.family == 'aarch64':
            simd_options.append('--enable-armv8-cntvct-el0')
