...
class Lammps(CMakePackage, CudaPackage):
    ...
    ### [RIST] added sha256 values of 20220612.1 20220623.2, and 20220623.3 ###
    version("20220623.3", sha256="d41cd5a4dfdd68e98eba4e947da8ed159c623a2862e1f75e4d262b36ae74492e")
    ...
    ### [RIST modified part start]
    ### This supported_packages part is rewritten 
    ### as in the package.py in the "develop" branch of spack (as of 23Feb2023)
    ...
    ### [RIST] cg-dna and user-cgdna are added
    supported_packages = {
        "asphere": {},
        "body": {},
        "bpm": {},
        ...
        "user-cgdna": {"when": "@20191030:20210527"},
    ...
    ### commented out lines below are the original lines in the package.py in the "fugaku_v0.19" branch
    #
    # # List of supported optional packages
    # # Note: package `openmp` in this recipe is called `openmp-package`, to avoid clash
    # # with the pre-existing `openmp` variant
