...
class Gromacs(CMakePackage):
    ...
    variant('fft', default='fftw3',
            description='The FFT library to be used',
            values=('fftw3', 'mkl', 'fftpack'))
    variant('subcounters', default=False,
            description='use builtin detailled counters')
    ...
    patch('a64fx.patch', when='@2020:2020.4 target=a64fx')

    patch('sve.patch', when='@2020.4:2020.99 +sve')
