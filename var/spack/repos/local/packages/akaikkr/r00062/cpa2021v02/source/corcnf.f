      subroutine corcnf(anclr,config,corlvl,ncmpx,ef,dsp)
c----------------------------------------------------------------------
...
c----------------------------------------------------------------------
      ...
      real*8 anclr(ncmpx),config(18,ncmpx,2),corlvl(18,ncmpx,2)
     &      ,ef(2)
...
c       ---------------------------------------------------------------
c
      data nconf/1,1,3,1,3,5,1,3,5,1,3,7,5,1,3/
...
c     --- up/down is reversed ---
     ...
     & '1s 2s 2p 3s 3p 3d 4s 4p 4d 5s 5p 4f 5d 6s 6p 5f 6d 7s'
      ...
      write(*,'(a,18i3/)')'   down  ',(int(config(i,j,2)),i=1,18)
      endif
   60 continue
      end
