...
c
     ...
     &    ,dmpc0/1d0/, itrmx/30/, nesitr/.false./
...
c  90 tcpa(l,l,n,k)=tcpa(l,l,n,k)+conc(ji)*t(l,ji,k)
      do 84 l=1,mmx
      do 84 k=1,kmx
...
c     is taken into account. To bridge this difference, the
c     t-matrix and tcpa are transformed into real harmonics
c     representation.
      if(ls) then
      do 210 i=1,natm
