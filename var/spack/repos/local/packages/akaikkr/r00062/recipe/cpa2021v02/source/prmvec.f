      subroutine prmvec(ibrav,coa,boa,alpha,beta,gamma,vc,r,g)
c-----------------------------------------------------------------------
...
c-----------------------------------------------------------------------
      ...
      parameter(c0=0d0,c1=0.5d0,c2=-0.5d0,c3=1d0
     &         ,c5=8.660254037844386d-1,c6=-c5)
c     --- c5=sqrt(3d0)/2d0 ---
      real*8 r(3,3),g(3,3),prmr(3,3,15),rlng(3),rprd(3)
      data prmr
...
c
c     reverse setting
c     r(2,1)=(1d0/2d0)/snrm
c     r(3,1)=z/snrm
c     r(1,2)=(-sqrt(3d0)/2d0)/snrm
c     r(2,2)=(1d0/2d0)/snrm
c     r(3,2)=z/snrm
c     r(1,3)=0d0
c     r(2,3)=-1d0/snrm
c     r(3,3)=z/snrm
...
c     --- z-components of a, b, c are same
...
c     --- calculate primitive cell volume ---
  180 vc=(r(2,1)*r(3,2)-r(3,1)*r(2,2))*r(1,3)
